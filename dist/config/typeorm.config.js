...
exports.typeOrmConfig = {
    ...
    entities: [task_entity_1.Task, feedback_entity_1.Feedback, customer_entity_1.Customer, sell_entity_1.Sell, sell_cost_entity_1.SellCost, other_costs_entity_1.OtherCosts],
    synchronize: true,
};
